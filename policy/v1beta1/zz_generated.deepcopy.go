...
func (in *AttributeManifest) DeepCopyInto(out *AttributeManifest) {
	*out = *in
	if in.Attributes != nil {
		...
		*out = make(map[string]*AttributeManifest_AttributeInfo, len(*in))
		for key, val := range *in {
			if val == nil {
				(*out)[key] = nil
			} else {
				(*out)[key] = new(AttributeManifest_AttributeInfo)
...
func (in *Rule) DeepCopyInto(out *Rule) {
	*out = *in
	...
	if in.RequestHeaderOperations != nil {
		...
		*out = make([]*Rule_HeaderOperationTemplate, len(*in))
		for i := range *in {
			if (*in)[i] == nil {
				(*out)[i] = nil
			} else {
				(*out)[i] = new(Rule_HeaderOperationTemplate)
				(*in)[i].DeepCopyInto((*out)[i])
			}
		}
	}
