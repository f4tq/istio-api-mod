...
import (
	...
	rbac_v1alpha1 "github.com/f4tq/istio-api-mod/pkg/kube/apis/rbac/v1alpha1"
	...
	v1alpha1 "github.com/f4tq/istio-api-mod/pkg/kube/listers/rbac/v1alpha1"
...
func NewFilteredClusterRbacConfigInformer(client versioned.Interface, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&rbac_v1alpha1.ClusterRbacConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterRbacConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rbac_v1alpha1.ClusterRbacConfig{}, f.defaultInformer)
}
